...
stls.height({ pass: { arrayValue: [jsvals.j8({pass: {
      ...
      componentSvg: (Svg:any, SvgObj:any) => {
        const { Defs, Stop, Path, LinearGradient, G, Circle, Rect, Mask } = SvgObj;
        return (props:any) => (<Svg xmlns="http://www.w3.org/2000/svg" width={28} height={27} viewBox="0 0 28 27" {...props} > <Path fill="#fff" stroke="#fff" strokeWidth={0.3} {...props} d="M26.99 4.881a.649.649 0 0 1 .121.647l-1.445 5.96 1.324-6.607Zm0 0-.003-.004m.003.004-.003-.004m0 0a.908.908 0 0 0-.578-.284m.578.284-.578-.285m0 0h-.012m.012 0h-.012m0 0L6.869 4.326 6.36 2.794m20.037 1.798L6.36 2.794m0 0v-.002m0 .002v-.002m0 0A2.922 2.922 0 0 0 3.624.85M6.36 2.792 3.625.85m0 0h-.001m.001 0h-.001m0 0h-2.02a.749.749 0 0 0-.754.744c0 .413.34.744.753.744h2.02a1.416 1.416 0 0 1 1.307.938v.001l3.811 11.317-.278.63M3.623.85l4.84 14.374m0 0-.002.006m.002-.006-.002.006m0 0c-.355.9-.248 1.912.286 2.721M8.46 15.23l.286 2.722m0 0a2.965 2.965 0 0 0 2.382 1.314m-2.382-1.314 2.382 1.314m0 0h.005m-.005 0h.005m0 0h11.732c.414 0 .753-.331.753-.744a.749.749 0 0 0-.753-.744h-11.73a1.393 1.393 0 0 1-1.142-.643m1.14 2.13-1.14-2.13m0 0a1.462 1.462 0 0 1-.139-1.289l.204-.45 12.611-1.299M9.995 17.136l12.677-3.038m0 0a3.45 3.45 0 0 0 2.995-2.608l-2.995 2.608Zm1.527-2.947v.003a1.891 1.891 0 0 1-1.706 1.458h-.003l-12.427 1.265-2.7-8.06 18.088.261-1.252 5.073ZM9.294 20.422c-1.58 0-2.864 1.262-2.864 2.823s1.284 2.823 2.864 2.823c1.58 0 2.864-1.262 2.864-2.823s-1.284-2.823-2.864-2.823Zm0 4.158c-.752 0-1.358-.6-1.358-1.335s.606-1.335 1.358-1.335c.752 0 1.358.6 1.358 1.335s-.606 1.335-1.358 1.335Zm11.46-4.158c-1.58 0-2.864 1.262-2.864 2.823s1.285 2.823 2.865 2.823c1.58 0 2.864-1.262 2.864-2.823s-1.285-2.823-2.864-2.823Zm0 4.158c-.752 0-1.357-.6-1.357-1.335s.605-1.335 1.358-1.335c.752 0 1.358.6 1.358 1.335s-.606 1.335-1.358 1.335Z" /> </Svg>)
      },
